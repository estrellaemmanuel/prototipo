 ...
 * @author LUCAS
 */
public class C_G_Cliente  extends DBSetencias {
    ...
    public void BuscarCliente(String valor, String filtro, JTable table){
    ...
    public void EliminarCliente (int Id){
        //  cambiar los valores para que acpete la eliminacion de un cliente
    ...
    public void CrearClientes ( String  nombre, String apellido,int dni,int cuil, String email,int telefono,String condicion_iva) {
        try {
     ...
     public void ActualizarCliente( int Id, String  nombre, String Descripcion,int Precio,int Stock) {
        /// modificar para que actualice un cliente
         try {

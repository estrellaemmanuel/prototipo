 ...
 * @author Programmer
 */
public class ActualizarProducto_por_empleado extends javax.swing.JFrame {
   ...
   ControladorGeneral gg;
    ...
    public ActualizarProducto_por_empleado() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarProducto_por_empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarProducto_por_empleado().setVisible(true);
            }
        });
    }
